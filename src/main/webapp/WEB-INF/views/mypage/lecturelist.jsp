...
<head>
    <meta charset="UTF-8">
    <title>마이페이지</title>
    <link rel="stylesheet" href="<c:url value='/resources/css/mypage/mypage_template.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/css/mypage/lecturelist.css'/>">
    <script defer src="<c:url value='/resources/js/mypage/lecturelist.js'/>"></script>
</head>
<body>
<div id="wrap">
    <!-- 왼쪽 사이드바 -->
    <div id="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="menu_title"><a href="/index/mypage/modifyresult">회원 정보 수정</a></li>
